              ...
              return (
                <div className="card mb-3" key={u._id}>
                  <div className="card-body">
                    <h4 className="text-3xl font-semibold my-2 text-red-900">
                      {u.nombre} {u.apellido}
                    </h4>
                    <p className="card-text">
                      <b>Identificación:</b> {u.identificacion}
                    </p>
                    <p className="card-text">
                      <b>Email:</b> {u.correo}
                    </p>
                    ...
                    >
                      <button className="bg-red-700 text-white font-bold text-xl py-2 px-1 rounded-xl hover:bg-red-500 shadow-md my-1">
                        EDITAR
                      </button>
                    </Link>
                  </div>
